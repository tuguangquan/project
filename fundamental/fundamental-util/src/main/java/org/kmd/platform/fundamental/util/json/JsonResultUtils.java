package org.kmd.platform.fundamental.util.json;

/**
 * Created by Administrator on 2017/5/15 0015.
 */
import com.google.common.collect.Maps;
import org.kmd.platform.fundamental.util.xss.XSSUtil;
...
public final class JsonResultUtils {
    public enum Code {
        SUCCESS(200, "操作成功！"), ERROR(500, "对不起，操作出错！"), NOTFOUND(404,
                ...
                "对不起，您没有进行此项操作的权限"), ILLEGA(422, "请求服务参数异常"),QUESTION(505,"出现问题,需要补全操作!");
